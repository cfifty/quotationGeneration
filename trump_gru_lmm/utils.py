...
def load_data(filename="data/ciceroquotes.csv", vocabulary_size=1000, min_sent_characters=0):
...
def train_with_sgd(model, X_train, y_train, learning_rate=0.001, nepoch=500, decay=0.9,
...
def generate_sentence(model, index_to_word, word_to_index, min_length=3):

...
with open('data/ciceroquotes.csv', 'rb') as f:
...
load_model_parameters_theano('./data/rnn-theano-80-4245-2018-05-20-10-00-26.npz',model)
...
with open('theano_trained_rnn_cicero.csv', "wb") as f:
